...
{
    public partial class Uc_StoreOptions : UserControl
    {
        
        DAL.DataAccesslayer1 dal = new DAL.DataAccesslayer1();
        string btnKind = "";
        public Uc_StoreOptions()
        {
            InitializeComponent();
        ...
        private void search_(string btn,string MainID)
        {
           ...
           if (btn == "account")
            ...
            {
                btnKind = "Transaction";
                setDgvLocation(btnToTranscation.Location.X, btnToTranscation.Location.Y);
                dgv1.DataSource = dal.getDataTabl_1("SELECT INV_CODE, INV_NAME  FROM WH_INV_TYPE where INV_NAME like '%" + txtTransactionDes.Text + "%'  ORDER BY INV_CODE ");
            }
        ...
        private void dgv1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else if (btnKind == "Transaction")
            {
               txtTransactionCode.Text = dgv1.Rows[ii].Cells[0].Value.ToString();
                txtTransactionDes.Text = dgv1.Rows[ii].Cells[1].Value.ToString();
        ...
        private void ItemID1_Enter(object sender, EventArgs e)
        {
            uc_SearchItem1.Visible = false;
        }

        private void btnToTranscation_Click(object sender, EventArgs e)
        {
            search_("Transaction", "");
        }

        private void txtTransactionDes_KeyUp(object sender, KeyEventArgs e)
        {
            search_("Transaction", "");
            
        }

        private void txtTransactionCode_Enter(object sender, EventArgs e)
        {
            dgv1.Visible = false;
        }

        private void txtTransactionCode_Leave(object sender, EventArgs e)
        {
            leaveID("Transaction", "", "");
        }
        ...
        private void LcAccountDesc_Enter(object sender, EventArgs e)
        {
