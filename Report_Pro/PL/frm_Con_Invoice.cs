...
{
    public partial class frm_Con_Invoice : Form
    {
        bool IsNew;
     ...
     VALUES ('" + acc_year.Text + "','" + Properties.Settings.Default.BranchId + "')");
        ...
        {
            DataTable dt_ratio = dal.getDataTabl_1(@"select PROJ_CODE,DP_Ratio,DP_Acc  from Projects where PROJ_CODE = '" + Uc_Project.ID.Text + "'");
...

        {
            ...
            M.descr,M.Descr_eng, br.branch_name,BR.WH_E_NAME,Br.Branch_Logo_A4,PT.Payment_name,U.unit_Description, U.unit_Description_E,J.PROJ_name,J.PROJ_E_name,A.Dowen_Payment_acc_no,A.Dowen_Payment,A.Dowen_Payment_Vat,A.Sales_Vat
            ,A.REQUIST_NO, B.VAT_RATIO as VatRatio,isnull(A.Dowen_Payment_Ratio,0) as Dowen_Payment_Ratio " +
